...
from Seminar_2.Task_2.shop import Shop, Product, Cart
...
class TestShop(unittest.TestCase):
    ...
    def test_changing_quantity_products_store(self):
        stock = self.shop.get_product_by_id(1).quantity
        self.cart.add_product_by_id(1)
    ...
    def test_select_incorrect_product_id_exception(self):
        self.assertRaisesRegex(RuntimeError, 'В корзине не найден товар с ID: 20',
